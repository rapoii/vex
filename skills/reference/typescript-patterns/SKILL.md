...
description: Implement concrete workflows and best practices for typescript-patterns.
...
Actionable steps and concrete examples for typescript-patterns.

## When to Activate
- Task involves typescript patterns.
