---
name: ci-cd-setup
description: Implement concrete workflows and best practices for ci-cd-setup.
...
Actionable steps and concrete examples for ci-cd-setup.

## When to Activate
- Task involves ci cd setup.
