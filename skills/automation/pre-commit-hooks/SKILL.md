...
description: Implement concrete workflows and best practices for pre-commit-hooks.
...
Actionable steps and concrete examples for pre-commit-hooks.

## When to Activate
- Task involves pre commit hooks.
