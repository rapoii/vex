...
description: Implement concrete workflows and best practices for dependency-audit.
...
Actionable steps and concrete examples for dependency-audit.

## When to Activate
- Task involves dependency audit.
