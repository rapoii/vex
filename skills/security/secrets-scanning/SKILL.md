...
description: Implement concrete workflows and best practices for secrets-scanning.
...
Actionable steps and concrete examples for secrets-scanning.

## When to Activate
- Task involves secrets scanning.
