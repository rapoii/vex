---
name: auth-hardening
description: Implement concrete workflows and best practices for auth-hardening.
...
Actionable steps and concrete examples for auth-hardening.

## When to Activate
- Task involves auth hardening.
