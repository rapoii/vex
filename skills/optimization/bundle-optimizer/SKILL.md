...
description: Implement concrete workflows and best practices for bundle-optimizer.
...
Actionable steps and concrete examples for bundle-optimizer.

## When to Activate
- Task involves bundle optimizer.
