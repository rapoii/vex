...
description: Implement concrete workflows and best practices for context-window-manager.
...
Actionable steps and concrete examples for context-window-manager.

## When to Activate
- Task involves context window manager.
...
npm test -- context-window-manager
```
