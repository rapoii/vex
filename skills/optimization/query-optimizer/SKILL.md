...
description: Implement concrete workflows and best practices for query-optimizer.
...
Actionable steps and concrete examples for query-optimizer.

## When to Activate
- Task involves query optimizer.
